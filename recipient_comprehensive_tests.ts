...
export const INITIAL_RECIPIENT_TESTS: MedicalTestItem[] = [
    // --- Blood Tests & Laboratory Studies ---
    { id: 'blood_group', name: 'Blood Grouping', value: '', normalRange: 'A/B/AB/O [+/-]', isAbnormal: false, isCompleted: false, category: 'Blood Tests & Laboratory Studies', inputType: 'text' },
